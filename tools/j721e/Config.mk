...
ifeq ($(CONFIG_J721E_UF2_BINARY),y)
ifdef PICO_SDK_PATH
define POSTBUILD
	$(Q)echo "Generating: nuttx.uf2"; \

	+$(Q) $(MAKE) -C $(TOPDIR)$(DELIM)tools$(DELIM)j721e -f Makefile.host
	tools$(DELIM)j721e$(DELIM)elf2uf2$(HOSTEXEEXT) nuttx nuttx.uf2;
